...
<div class="container-fluid">
   <!-- Input -->
    <form action="{{ route('admin.updatepromotion', ['id'=>$KM->km_id]) }}" method="POST">
        @csrf
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" value="{{$KM->km_macode}}" name="km_macode" class="form-control" />
                                    </div>
                                </div>
                            </div>
                        </div>

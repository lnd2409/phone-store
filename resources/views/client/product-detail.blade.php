        ...
        <div class="my-md-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                    ...
                    <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a href="{{ route('client.get-product-by-cat', ['idCate'=>$sanPham->theloai->tl_tenkhongdau]) }}">{{ $sanPham->theloai->tl_ten }}</a></li>
                    <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">{{ $sanPham->sp_ten }}</li>
                </ol>
            </nav>
        </div>
        <!-- End breadcrumb -->
                ...
                <div class="mb-2">
                    <div class="border-bottom mb-3 pb-md-1 pb-3">
                        ...
                        <div class="d-md-flex align-items-center">
                            <a href="#" class="max-width-150 ml-n2 mb-2 mb-md-0 d-block"><img class="img-fluid" src="{{ asset('template/client') }}/assets/img/200X60/img1.png" alt="Image Description"></a>
                    ...
                    <div class="border-top border-bottom py-3 mb-4">
                        <div class="d-flex align-items-center">
                            ...
                            </select><button type="button" class="btn dropdown-toggle btn-sm bg-white font-weight-normal py-2 border" data-toggle="dropdown" role="button" title="White with Gold"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner">White with Gold</div></div> </div></button><div class="dropdown-menu " role="combobox"><div class="inner show" role="listbox" aria-expanded="false" tabindex="-1"><ul class="dropdown-menu inner show"></ul></div></div></div>
                            <!-- End Select -->
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="Jpills-two-example1" role="tabpanel" aria-labelledby="Jpills-two-example1-tab">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <img class="img-fluid mr-n4 mr-lg-n10" src="{{ asset('template/client') }}/assets/img/580X580/img1.jpg" alt="Image Description">
                        </div>
                        <div class="col-md-6 text-left">
                            <img class="img-fluid ml-n4 ml-lg-n10" src="{{ asset('template/client') }}/assets/img/580X580/img2.jpg" alt="Image Description">
                        </div>
